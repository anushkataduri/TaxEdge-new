...
import { BrandColors, Colors } from "../../../../design-system/colors";
    ...
    >
      ...
      >
        <TouchableOpacity
          activeOpacity={0.7}
          onPress={() => router.back()}
          style={[styles.backBtn, { top: insets.top + HEADER_OFFSET }]}
        >
                    ...
                    style={[
                      styles.dotBox,
                      {
                        ...
                        backgroundColor: filled
                          ? BrandColors.PRIMARY_BLUE
                          : BrandColors.WHITE,
                        borderWidth: current ? BorderWidth.thick : BorderWidth.medium,
                      },
                    ]}
                  >
                    {filled ? (
